					...
					<td>
						<?php echo $product['excerpt'];
							if(isset($product['options'])) {
                                echo product_options_html($product['options']);
							}
							?>
					</td>
								...
								<div class="control-group">
									<div class="controls">
										<div class="input-append">
											<input class="qty" name="cartkey[<?php echo $cartkey;?>]"  value="<?php echo $product['quantity'] ?>" type="text"><button class="btn btn-danger" title="Remove item from cart" type="button" onclick="if(confirm('<?php echo lang('remove_item');?>')){window.location='<?php echo site_url('cart/remove_item/'.$cartkey);?>';}"><i class="icon-remove icon-white"></i></button>
										</div>
									</div>
								</div>
							<?php else:?>
