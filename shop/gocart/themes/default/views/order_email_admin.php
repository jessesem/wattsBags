...
<h3><?php echo lang('order_number')?>: <?php echo $order_id ?> [<a href="<?= site_url("admin/orders/order/{$order_primary_key}"); ?>" target="_blank">View in Admin</a>]</h3>
...
<table width="100%" cellpadding="10" border="0">
	<tr>
		...
		<td>
            ...
            Card Holder: <?php echo $cc['CardHolder'] ?><br>
            Card Type: <?php echo $cc['CardType'] ?><br>
            Card Number: <?php echo $cc['CardNumber'] ?><br>
            Validity: <?php echo $cc['Validity'] ?><br>
            CV2: <?php echo $cc['CV2'] ?><br>
        </td>
	</tr>
</table>
</div>
